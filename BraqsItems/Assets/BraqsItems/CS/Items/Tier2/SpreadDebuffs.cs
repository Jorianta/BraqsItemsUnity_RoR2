...
namespace BraqsItems
{
    public class SpreadDebuffs
    {
        ...
        public static void inflictInfection(CharacterBody body, CharacterBody attacker, int stacks)
        {
            ...
            if (body.TryGetComponent(out BraqsItems_InfectedBehaviour component) && component.stack >= stacks) return;

            component = body.AddItemBehavior<BraqsItems_InfectedBehaviour>(stacks);
        ...
        {
            if (body.TryGetComponent(out BraqsItems_InfectedBehaviour component))
            {
        ...
        public class BraqsItems_InfectedBehaviour : CharacterBody.ItemBehavior
        {
